...
void test1()
{
    ...
    assert(RLEListRemove(myList,0) == RLE_LIST_SUCCESS);
    printRLEList(myList);
    ...
    assert(RLEListGet(myList,0,&myResult) == 'A');
    assert(myResult == RLE_LIST_SUCCESS);

    assert(RLEListGet(myList,2,&myResult) == 'C');
    assert(myResult == RLE_LIST_SUCCESS);
...
void test4()
{
    ...
    printf("Get index==0\n");
    printf("%c\n", RLEListGet(myList,0,&myResult));

    printf("Get index==1\n");
    printf("%c\n", RLEListGet(myList,1,&myResult));

    printf("Get index==2\n");
    printf("%c\n", RLEListGet(myList,2,&myResult));

    printf("Remove index==1\n");
    myResult = RLEListRemove(myList,1);
    printRLEList(myList);

    printf("Remove index==0\n");
    myResult = RLEListRemove(myList,0);
    printRLEList(myList);

    printf("Remove index==11\n");
    RLEListRemove(myList,11);
    printRLEList(myList);
